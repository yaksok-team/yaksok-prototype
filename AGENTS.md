...
→ **상세 절차·rollback 포함은 [.Codex/skills/yaksok-screen-design/SKILL.md](.Codex/skills/yaksok-screen-design/SKILL.md)** (Codex skill — 화면 추가·제거 발화 시 자동 트리거).
